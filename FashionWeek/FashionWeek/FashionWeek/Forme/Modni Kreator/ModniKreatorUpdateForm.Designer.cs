...
{
    partial class ModniKreatorUpdateForm
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ModniKreatorUpdateForm));
            ...
            cmdDodajModnogKreatora.Location = new Point(175, 485);
            ...
            cmdDodajModnogKreatora.Text = "Izmeni Modnog Kreatora";
            cmdDodajModnogKreatora.UseVisualStyleBackColor = false;
            cmdDodajModnogKreatora.Click += cmdIzmeniModnogKreatora_Click;
            // 
            // groupBox1
            // 
            ...
            groupBox1.Location = new Point(51, 36);
            ...
            cenaUsluge.Minimum = new decimal(new int[] { 150, 0, 0, 0 });
            cenaUsluge.Name = "cenaUsluge";
            cenaUsluge.Size = new Size(157, 27);
            cenaUsluge.TabIndex = 36;
            cenaUsluge.Value = new decimal(new int[] { 170, 0, 0, 0 });
            // 
            // label1
            // 
            ...
            // 
            // ModniKreatorUpdateForm
            // 
            AutoScaleDimensions = new SizeF(8F, 20F);
            AutoScaleMode = AutoScaleMode.Font;
            BackgroundImage = (Image)resources.GetObject("$this.BackgroundImage");
            ClientSize = new Size(558, 583);
            Controls.Add(cmdDodajModnogKreatora);
            Controls.Add(groupBox1);
            Margin = new Padding(3, 4, 3, 4);
            Name = "ModniKreatorUpdateForm";
            Text = "ModniKreatorUpdateForm";
            Load += ModniKreatorUpdateForm_Load;
